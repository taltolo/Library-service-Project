...
public class SearchmemberManagerController {
    ...
    public static Stage searchmemberManagerControllerStage;
		...
		Platform.runLater(new Runnable() {
			...
			public void run() {
				try
				{
					...
					lonerMember=addLoan;
					System.out.println(addLoan.getFirstname());
    ...
    void InventorybntHandler(ActionEvent event) {
    	Platform.runLater(new Runnable() {
			@Override
			public void run() {
				Main.client.searchmemberManagerController.searchmemberManagerControllerStage.close();
	...
	void SearchHandler(ActionEvent event) {
		...
		Main.libraryManagerController.searchForMember(where,search);
	...
	void ViewMemberbntHandler(ActionEvent event) throws IOException {
		...
		Member addLoan=(Member)object;
		lonerMember=addLoan;
		Main.libraryManagerController.getAllActivitiesMember(addLoan);
	...
	public void openViewStage() {
		...
		Platform.runLater(new Runnable() {
			...
			public void run() {
				...
				Main.client.searchmemberManagerController.searchmemberManagerControllerStage.close();
				Stage primaryStage = new Stage();
				Main.client.viewMemberManagerController.viewMemberManagerControllerStage=primaryStage;
				FXMLLoader loader = new FXMLLoader(getClass().getResource("ViewMemberManager.fxml"));
				System.out.println(getClass().getResource("ViewMemberManager.fxml"));
				AnchorPane pane;
				try {
	...
	public void initialize() {
		...
		Main.client.searchmemberManagerController=this;
